# Generated by Powerlevel10k configuration wizard on 2023-05-29 at 20:04 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    my_config_status        # line 1712
    my_aur_status           # line 1723
  ...
  # check config
  function prompt_my_config_status() {
    commits_diff=$(git -C "$HOME/.dotfiles/" rev-list --count HEAD...@{upstream})

    outdated=''
    if [ "$commits_diff" != "0" ]; then
      outdated='1'
    fi
    p10k segment -b 1 -f "white" -i $'\ue615' -t "!" -c "$outdated"
  }

  # check aur
  function prompt_my_aur_status() {
    pkgs=$(yay -Qu | grep "" -c)
    ...
    p10k segment -b 1 -f "white" -i $'\uf1b2' -t "$pkgs!" -c "$outdated"
  }
